...
function addUser(PDO $pdo, string $username, string $email, string $password): bool|array
{
...
//  On va créé une fonction qui va nous permettre la connexion d'utilisateur // 
